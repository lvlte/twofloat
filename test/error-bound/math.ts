...
const fnBySig = {
  'op1': {square1, cube1, sqrt1, ln1, log2_1, log10_1, rempi_1, rem2pi_1, sin1, cos1, tan1, cot1},
  'op2': {square2, cube2, sqrt2, ln2, log2_2, log10_2, rempi_2, rem2pi_2, sin2, cos2, tan2, cot2},
